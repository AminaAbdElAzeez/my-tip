...
import { message, Descriptions, Tooltip, Form, Modal, Select, Input, Button } from 'antd';
...
function CityDetails() {
  ...
  const fetchCity = async () => {
    ...
    try {
      ...
      message.error('Failed to fetch city');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <section>
      <div className="flex justify-end items-center gap-2">
        {/* Delete */}
        <Tooltip title={intl.formatMessage({ id: 'deleteCity' })} color="#d30606ff">
          <FiTrash
