...
import EmployerStatistics from "./pages/dashboard/(employer)/statistics/page";
import PaymentMethod from "./pages/dashboard/(employer)/paymentMethod/page";
import Positions from "./pages/dashboard/(employer)/positions/page";
import PositionsDetails from "./pages/dashboard/(employer)/positions/positionDetails/page";
import Employees from "./pages/dashboard/(employer)/employees/page";
import Branches from "./pages/dashboard/(employer)/branches/page";
import Transactions from "./pages/dashboard/(employer)/transactions/page";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "positions",
            element: <Positions />,
            children: [{ path: ":id", element: <PositionsDetails /> }],
          },
          {
            path: "employees",
            element: <Employees />,
            children: [{ path: ":id", element: <EmployeesDetails /> }],
          },
          {
            path: "branches",
            element: <Branches />,
          },
          {
            ...
            children: [{ path: ":id", element: <TransactionsDetails /> }],
          },
          {
            path: "wallet",
            element: <Wallet />,
